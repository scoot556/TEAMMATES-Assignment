    ...
    private void verifyFileContentForSession1InCourse1WithNewLastName(String fileContent,
        ...
        */
        String[] expected = {
                ...
                "",
                "Team,Giver's Full Name,Giver's Last Name,Giver's Email,Recipient's Team,Recipient's Full Name,Recipient's Last Name,Recipient's Email,Feedback,Comment From,Comment",
                "\"Team 1.1</td></div>'\"\"\",\"new name new last name\",\"new last name\",\"student1InCourse1@student.rmit.edu.au\",\"Team 1.1</td></div>'\"\"\",\"new name new last name\",\"new last name\",\"student1InCourse1@student.rmit.edu.au\",\"Student 1 self feedback.\",Instructor1 Course1,\"Instructor 1 comment to student 1 self feedback\"",
                "\"Team 1.1</td></div>'\"\"\",\"student2 In Course1\",\"Course1\",\"student2InCourse1@student.rmit.edu.au\",\"Team 1.1</td></div>'\"\"\",\"student2 In Course1\",\"Course1\",\"student2InCourse1@student.rmit.edu.au\",\"I'm cool'\""
                // CHECKSTYLE.ON:LineLength
        };
    ...
    private void verifyFileContentForSession1InCourse1WithinSection1(String fileContent,
        ...
        */
        ...
        String[] expected = {
                ...
                "\"Team 1.1</td></div>'\"\"\",\"student1 In Course1</td></div>'\"\"\",\"Course1</td></div>'\"\"\",\"student1InCourse1@student.rmit.edu.au\",\"Team 1.1</td></div>'\"\"\",\"student1 In Course1</td></div>'\"\"\",\"Course1</td></div>'\"\"\",\"student1InCourse1@student.rmit.edu.au\",\"Student 1 self feedback.\"",
                "\"Team 1.1</td></div>'\"\"\",\"student2 In Course1\",\"Course1\",\"student2InCourse1@student.rmit.edu.au\",\"Team 1.1</td></div>'\"\"\",\"student2 In Course1\",\"Course1\",\"student2InCourse1@student.rmit.edu.au\",\"I'm cool'\""
                // CHECKSTYLE.ON:LineLength
        };
