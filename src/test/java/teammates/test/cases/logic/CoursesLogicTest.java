...
public class CoursesLogicTest extends BaseLogicTest {
    ...
    private void testGetCourseStudentListAsCsv() throws Exception {
        ...
        String[] expectedCsvString = {
                ...
                "\"Section 2\",\"Team 1.2\",\"student5 In Course1\",\"Course1\",\"Joined\",\"student5InCourse1@student.rmit.edu.au\"",
                ""
        ...
        expectedCsvString = new String[] {
                ...
                "\"Team 2.1\",\"student1 In Course2\",\"Course2\",\"Joined\",\"student1InCourse2@student.rmit.edu.au\"",
                "\"Team 2.1\",\"student2 In Course2\",\"Course2\",\"Joined\",\"student2InCourse1@student.rmit.edu.au\"",
                ""
                // CHECKSTYLE.ON:LineLength
        };
        ...
        expectedCsvString = new String[] {
                ...
                "",
                "Section,Team,Full Name,Last Name,Status,Email",
                "\"Section 1\",\"Team 1\",\"student1 In unregisteredCourse\",\"unregisteredCourse\",\"Yet to join\",\"student1InUnregisteredCourse@student.rmit.edu.au\"",
                "\"Section 2\",\"Team 2\",\"student2 In unregisteredCourse\",\"unregisteredCourse\",\"Yet to join\",\"student2InUnregisteredCourse@student.rmit.edu.au\"",
                ""
                // CHECKSTYLE.ON:LineLength
        };
