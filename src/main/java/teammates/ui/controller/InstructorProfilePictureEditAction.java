...
public class InstructorProfilePictureEditAction extends Action {
    ...
    protected ActionResult execute() {
        ...
        if (!validatePostParameters()) {
            return createRedirectResult(Const.ActionURIs.INSTRUCTOR_PROFILE_PAGE);
        }
    ...
    private byte[] transformImage() {
        try {
            ...
            isError = true;
            statusToUser.add(new StatusMessage(Const.StatusMessages.INSTRUCTOR_PROFILE_PICTURE_EDIT_FAILED,
                                               StatusMessageColor.DANGER));
