...
import teammates.ui.pagedata.InstructPageData;
...
public class InstructorProfileEditBox {
    ...
    public InstructorProfileEditBox(String name, String isEditingPhoto, InstructorProfileAttributes profile,
        ...
        this.nationalitySelectField = InstructPageData.getNationalitiesAsElementTags(profile.nationality);
        this.legacyNationalityInstructions = InstructPageData.getLegacyNationalityInstructions(profile.nationality);
