...
public class InstructorReportsAjaxPageData extends PageData {

    private CourseTable courseTable;
    private int index;

    public InstructorReportsAjaxPageData(AccountAttributes account, String sessionToken) {
        ...
        for (FeedbackSessionAttributes session : sessions) {
            InstructorHomeFeedbackSessionRow row = new InstructorHomeFeedbackSessionRow(
                    ...
                    getInstructorFeedbackSessionActions(
                            session, Const.ActionURIs.INSTRUCTOR_REPORTS_PAGE, instructor));
