 ...
 */
public enum InstructorUpdateStatus {
    ...
    InstructorUpdateStatus(int numericRepresentation) {
        this.numericRepresentation = numericRepresentation;
    }

    public static InstructorUpdateStatus enumRepresentation(int numericRepresentation) {
