...
public class InstructorProfileAttributes extends EntityAttributes<InstructorProfile> {
    ...
    public static InstructorProfileAttributes valueOf(InstructorProfile sp) {
    ...
    public InstructorProfile toEntity() {
        return new InstructorProfile(googleId, shortName, email, institute, nationality, gender,
