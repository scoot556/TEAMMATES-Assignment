 ...
 */
public class InstructProfilesDb extends EntitiesDb<InstructorProfile, InstructorProfileAttributes> {
    ...
    private InstructorProfile getInstructorProfileEntityForLegacyData(String googleId) {
        InstructAccount account = ofy().load().type(InstructAccount.class).id(googleId).now();
    ...
    private InstructorProfile getInstructorProfileEntityFromDb(String googleId) {
        Key<InstructAccount> parentKey = Key.create(InstructAccount.class, googleId);
    ...
    protected QueryKeys<InstructorProfile> getEntityQueryKeys(InstructorProfileAttributes attributes) {
        Key<InstructAccount> parentKey = Key.create(InstructAccount.class, attributes.googleId);
