...
@Entity
@Index
public class InstructAccount extends BaseEntity {
    ...
    private boolean isInstructorProfileEnabled = true;

    @SuppressWarnings("unused")
    private InstructAccount() {
     ...
     */
    public InstructAccount(String googleId, String name, boolean isInstructor,
            String email, String institute, InstructorProfile instructProfile) {
        ...
        this.setInstructorProfile(instructProfile);
    }

    public InstructAccount(String googleId, String name, boolean isInstructor,
            String email, String institute) {
        this(googleId, name, isInstructor, email, institute, new InstructorProfile(googleId));
    }
    ...
    public InstructorProfile getInstructorProfile() {
        if (!isInstructorProfileEnabled) {
            return null;
        }
        if (instructorProfile == null) {
            return null;
        }
        return instructorProfile.get();
    }
    ...
    public void setInstructorProfile(InstructorProfile instructorProfile) {
        ...
        this.instructorProfile = Ref.create(instructorProfile);
    }
     ...
     */
    public void setIsInstructorProfileEnabled(boolean isInstructorProfileEnabled) {
        this.isInstructorProfileEnabled = isInstructorProfileEnabled;
    }
}
