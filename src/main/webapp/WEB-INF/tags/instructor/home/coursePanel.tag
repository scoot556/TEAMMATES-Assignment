...
<div class="panel panel-primary">
  ...
  <table class="table-responsive table table-striped table-bordered margin-0">
     ...
     <tr>
          <td>
          		<a href="/serve?blob-key=" target="_blank">View PDF</a>
     			<input type="hidden" name="pdf-attachment-key" value="" />
     	  </td>
     </tr>
     </c:if>
  </table>
	...
	<!-- <div class="panel-heading ajax_auto">
 	<div class="row">
 	<div class="col-sm-6">
 		<strong>Latest PDF Uploads</strong>
 	</div>
 	
      
        <c:if test="">
         <a class="btn btn-sm btn-warning" href="/serve?blob-key=" target="_blank">View PDF feedback</a>
         <input type="hidden" name="pdf-attachment-key" value="" />
       </c:if>
       <p>testing</p>
       </div>
