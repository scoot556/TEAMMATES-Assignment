...
<%@ tag description="instructorProfile - Upload photo modal" pageEncoding="UTF-8" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ tag import="teammates.common.util.Const" %>
<%@ attribute name="modal" type="teammates.ui.template.InstructorProfileUploadPhotoModal" required="true" %>
              ...
              <form id="profilePictureUploadForm" method="post">
                <span class="btn btn-primary profile-pic-file-selector">
                  ...
                  <input id="studentPhoto"
                      type="file"
                      name="<%= Const.ParamsNames.INSTRUCTOR_PROFILE_PHOTO %>">
                </span>
          ...
          <div class="col-xs-8 profile-pic-edit-col border-left-gray">
            <c:choose>
              ...
              <c:otherwise>
                ...
                <form id="profilePictureEditForm" method="post" action="<%= Const.ActionURIs.INSTRUCTOR_PROFILE_PICTURE_EDIT %>">
